...
curl -s -u root: -H "x-bigbytes-stage-name:s0011" -F "upload=@${CURDIR}/../../../data/csv/itt.csv" -XPUT "http://localhost:8000/v1/upload_to_stage" -u root: | jq ".data"
curl -s -u root: -H "x-bigbytes-stage-name:s0011" -F "upload=@${CURDIR}/../../../data/csv/sample.csv" -XPUT "http://localhost:8000/v1/upload_to_stage" -u root: | jq ".data"
curl -s -u root: -H "x-bigbytes-stage-name:s0011" -F "upload=@${CURDIR}/../../../data/csv/sample_3_replace.csv" -XPUT "http://localhost:8000/v1/upload_to_stage" -u root: | jq ".data"
curl -s -u root: -H "x-bigbytes-stage-name:s0011" -F "upload=@${CURDIR}/../../../data/csv/sample_3_duplicate.csv" -XPUT "http://localhost:8000/v1/upload_to_stage" -u root: | jq ".data"
...
## error test!!!
curl -s -u root: -H "x-bigbytes-stage-name:s0011" -F "upload=@${CURDIR}/../../../data/csv/sample_2_columns.csv" -XPUT "http://localhost:8000/v1/upload_to_stage" -u root: | jq ".data"
