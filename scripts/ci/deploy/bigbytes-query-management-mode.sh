...
echo 'Start bigbytes-query management-mode node'
nohup target/${BUILD_PROFILE}/bigbytes-query -c scripts/ci/deploy/config/bigbytes-query-management-mode.toml &
