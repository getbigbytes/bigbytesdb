...
echo 'Start bigbytesdb-query with native...'
nohup target/${BUILD_PROFILE}/bigbytesdb-query -c scripts/ci/deploy/config/bigbytesdb-query-node-native.toml --internal-enable-sandbox-tenant &
