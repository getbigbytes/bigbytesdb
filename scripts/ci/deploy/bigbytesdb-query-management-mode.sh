...
echo 'Start bigbytesdb-query management-mode node'
nohup target/${BUILD_PROFILE}/bigbytesdb-query -c scripts/ci/deploy/config/bigbytesdb-query-management-mode.toml &
