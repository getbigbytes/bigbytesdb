...
use bigbytesdb_storages_common_blocks::memory::InMemoryDataKey;
use bigbytesdb_storages_common_blocks::memory::IN_MEMORY_DATA;
...
use bigbytesdb_storages_common_table_meta::table_id_ranges::TEMP_TBL_ID_BEGIN;
