...
use bigbytes_common_ast::ast::AddColumnOption as AstAddColumnOption;
use bigbytes_common_ast::ast::AlterTableAction;
use bigbytes_common_ast::ast::AlterTableStmt;
use bigbytes_common_ast::ast::AnalyzeTableStmt;
use bigbytes_common_ast::ast::AttachTableStmt;
use bigbytes_common_ast::ast::ClusterOption;
use bigbytes_common_ast::ast::ClusterType as AstClusterType;
use bigbytes_common_ast::ast::ColumnDefinition;
use bigbytes_common_ast::ast::ColumnExpr;
use bigbytes_common_ast::ast::CompactTarget;
use bigbytes_common_ast::ast::CreateTableSource;
use bigbytes_common_ast::ast::CreateTableStmt;
use bigbytes_common_ast::ast::DescribeTableStmt;
use bigbytes_common_ast::ast::DropTableStmt;
use bigbytes_common_ast::ast::Engine;
use bigbytes_common_ast::ast::ExistsTableStmt;
use bigbytes_common_ast::ast::Expr;
use bigbytes_common_ast::ast::Identifier;
use bigbytes_common_ast::ast::InvertedIndexDefinition;
use bigbytes_common_ast::ast::ModifyColumnAction;
use bigbytes_common_ast::ast::OptimizeTableAction as AstOptimizeTableAction;
use bigbytes_common_ast::ast::OptimizeTableStmt;
use bigbytes_common_ast::ast::Query;
use bigbytes_common_ast::ast::RenameTableStmt;
use bigbytes_common_ast::ast::ShowCreateTableStmt;
use bigbytes_common_ast::ast::ShowDropTablesStmt;
use bigbytes_common_ast::ast::ShowLimit;
use bigbytes_common_ast::ast::ShowTablesStatusStmt;
use bigbytes_common_ast::ast::ShowTablesStmt;
use bigbytes_common_ast::ast::Statement;
use bigbytes_common_ast::ast::TableReference;
use bigbytes_common_ast::ast::TableType;
use bigbytes_common_ast::ast::TruncateTableStmt;
use bigbytes_common_ast::ast::TypeName;
use bigbytes_common_ast::ast::UndropTableStmt;
use bigbytes_common_ast::ast::UriLocation;
use bigbytes_common_ast::ast::VacuumDropTableStmt;
use bigbytes_common_ast::ast::VacuumTableStmt;
use bigbytes_common_ast::ast::VacuumTemporaryFiles;
...
use bigbytes_storages_common_table_meta::table::is_reserved_opt_key;
...
use bigbytes_storages_common_table_meta::table::OPT_KEY_ENGINE_META;
...
use bigbytes_storages_common_table_meta::table::OPT_KEY_TABLE_ATTACHED_DATA_URI;
...
impl Binder {
    ...
    pub(in crate::planner::binder) async fn bind_show_tables_status(
        ...
        // (unlike mysql, alias of derived table is not required in bigbytes).
        let query = match limit {
            None => format!(
