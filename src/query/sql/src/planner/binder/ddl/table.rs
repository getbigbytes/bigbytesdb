...
use bigbytesdb_common_ast::ast::AddColumnOption as AstAddColumnOption;
use bigbytesdb_common_ast::ast::AlterTableAction;
use bigbytesdb_common_ast::ast::AlterTableStmt;
use bigbytesdb_common_ast::ast::AnalyzeTableStmt;
use bigbytesdb_common_ast::ast::AttachTableStmt;
use bigbytesdb_common_ast::ast::ClusterOption;
use bigbytesdb_common_ast::ast::ClusterType as AstClusterType;
use bigbytesdb_common_ast::ast::ColumnDefinition;
use bigbytesdb_common_ast::ast::ColumnExpr;
use bigbytesdb_common_ast::ast::CompactTarget;
use bigbytesdb_common_ast::ast::CreateTableSource;
use bigbytesdb_common_ast::ast::CreateTableStmt;
use bigbytesdb_common_ast::ast::DescribeTableStmt;
use bigbytesdb_common_ast::ast::DropTableStmt;
use bigbytesdb_common_ast::ast::Engine;
use bigbytesdb_common_ast::ast::ExistsTableStmt;
use bigbytesdb_common_ast::ast::Expr;
use bigbytesdb_common_ast::ast::Identifier;
use bigbytesdb_common_ast::ast::InvertedIndexDefinition;
use bigbytesdb_common_ast::ast::ModifyColumnAction;
use bigbytesdb_common_ast::ast::OptimizeTableAction as AstOptimizeTableAction;
use bigbytesdb_common_ast::ast::OptimizeTableStmt;
use bigbytesdb_common_ast::ast::Query;
use bigbytesdb_common_ast::ast::RenameTableStmt;
use bigbytesdb_common_ast::ast::ShowCreateTableStmt;
use bigbytesdb_common_ast::ast::ShowDropTablesStmt;
use bigbytesdb_common_ast::ast::ShowLimit;
use bigbytesdb_common_ast::ast::ShowTablesStatusStmt;
use bigbytesdb_common_ast::ast::ShowTablesStmt;
...
use bigbytesdb_common_ast::ast::TruncateTableStmt;
use bigbytesdb_common_ast::ast::TypeName;
use bigbytesdb_common_ast::ast::UndropTableStmt;
use bigbytesdb_common_ast::ast::UriLocation;
use bigbytesdb_common_ast::ast::VacuumDropTableStmt;
use bigbytesdb_common_ast::ast::VacuumTableStmt;
use bigbytesdb_common_ast::ast::VacuumTemporaryFiles;
...
use bigbytesdb_storages_common_table_meta::table::is_reserved_opt_key;
...
use bigbytesdb_storages_common_table_meta::table::OPT_KEY_ENGINE_META;
...
use bigbytesdb_storages_common_table_meta::table::OPT_KEY_TABLE_ATTACHED_DATA_URI;
...
impl Binder {
    ...
    pub(in crate::planner::binder) async fn bind_show_tables_status(
        ...
        // (unlike mysql, alias of derived table is not required in bigbytesdb).
        let query = match limit {
            None => format!(
