...
use bigbytes_common_catalog::merge_into_join::MergeIntoJoin;
...
use bigbytes_common_catalog::runtime_filter_info::RuntimeFilterInfo;
use bigbytes_common_catalog::runtime_filter_info::RuntimeFilterReady;
use bigbytes_common_catalog::statistics::data_cache_statistics::DataCacheMetrics;
use bigbytes_common_catalog::table_args::TableArgs;
use bigbytes_common_catalog::table_context::ContextError;
use bigbytes_common_catalog::table_context::FilteredCopyFiles;
use bigbytes_common_catalog::table_context::StageAttachment;
...
use bigbytes_common_meta_app::principal::OnErrorMode;
...
use bigbytes_common_meta_app::principal::COPY_MAX_FILES_COMMIT_MSG;
use bigbytes_common_meta_app::principal::COPY_MAX_FILES_PER_COMMIT;
...
use bigbytes_common_pipeline_core::InputError;
...
use bigbytes_common_storage::MultiTableInsertStatus;
...
use bigbytes_common_storages_delta::DeltaTable;
use bigbytes_common_storages_fuse::TableContext;
use bigbytes_common_storages_iceberg::IcebergTable;
use bigbytes_common_storages_orc::OrcTable;
use bigbytes_common_storages_parquet::ParquetRSTable;
...
use bigbytes_storages_common_session::drop_table_by_id;
...
impl QueryContext {
    ...
    pub fn create_from_shared(shared: Arc<QueryContextShared>) -> Arc<QueryContext> {
        ...
        Arc::new(QueryContext {
            ...
            version: format!("Bigbytes Query {}", *BIGBYTES_COMMIT_VERSION),
            mysql_version: format!("{}-{}", MYSQL_VERSION, *BIGBYTES_COMMIT_VERSION),
...
impl TableContext for QueryContext {
    ...
    fn get_license_key(&self) -> String {
        ...
        if license.is_empty() {
            license = env!("BIGBYTES_ENTERPRISE_LICENSE_EMBEDDED").to_string();
        }
