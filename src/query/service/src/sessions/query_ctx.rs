...
use bigbytesdb_common_catalog::merge_into_join::MergeIntoJoin;
...
use bigbytesdb_common_catalog::runtime_filter_info::RuntimeFilterInfo;
use bigbytesdb_common_catalog::runtime_filter_info::RuntimeFilterReady;
use bigbytesdb_common_catalog::statistics::data_cache_statistics::DataCacheMetrics;
use bigbytesdb_common_catalog::table_args::TableArgs;
use bigbytesdb_common_catalog::table_context::ContextError;
use bigbytesdb_common_catalog::table_context::FilteredCopyFiles;
use bigbytesdb_common_catalog::table_context::StageAttachment;
...
use bigbytesdb_common_meta_app::principal::OnErrorMode;
...
use bigbytesdb_common_meta_app::principal::COPY_MAX_FILES_COMMIT_MSG;
use bigbytesdb_common_meta_app::principal::COPY_MAX_FILES_PER_COMMIT;
...
use bigbytesdb_common_pipeline_core::InputError;
...
use bigbytesdb_common_storage::MultiTableInsertStatus;
...
use bigbytesdb_common_storages_delta::DeltaTable;
use bigbytesdb_common_storages_fuse::TableContext;
use bigbytesdb_common_storages_iceberg::IcebergTable;
use bigbytesdb_common_storages_orc::OrcTable;
use bigbytesdb_common_storages_parquet::ParquetRSTable;
...
use bigbytesdb_storages_common_session::drop_table_by_id;
...
impl QueryContext {
    ...
    pub fn create_from_shared(shared: Arc<QueryContextShared>) -> Arc<QueryContext> {
        ...
        Arc::new(QueryContext {
            ...
            version: format!("Bigbytesdb Query {}", *BIGBYTESDB_COMMIT_VERSION),
            mysql_version: format!("{}-{}", MYSQL_VERSION, *BIGBYTESDB_COMMIT_VERSION),
...
impl TableContext for QueryContext {
    ...
    fn get_license_key(&self) -> String {
        ...
        if license.is_empty() {
            license = env!("BIGBYTESDB_ENTERPRISE_LICENSE_EMBEDDED").to_string();
        }
