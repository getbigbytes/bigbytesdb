...
use bigbytesdb_common_datavalues::DataTypeImpl;
use bigbytesdb_common_datavalues::DataValue;
...
pub fn from_schema(schema: &bigbytesdb_common_datavalues::DataSchema) -> TableSchema {
    let fields = schema
        .fields()
        .iter()
        .map(|f| {
