...
use bigbytes_common_datavalues::DataTypeImpl;
use bigbytes_common_datavalues::DataValue;
...
pub fn from_schema(schema: &bigbytes_common_datavalues::DataSchema) -> TableSchema {
    let fields = schema
        .fields()
        .iter()
        .map(|f| {
