...
#[test]
fn v101_database_meta() -> anyhow::Result<()> {
    let bytes: Vec<u8> = vec![
        ...
        101, 168, 6, 24, 218, 1, 8, 101, 110, 100, 112, 111, 105, 110, 116, 226, 1, 11, 10, 9, 8,
        128, 8, 160, 6, 101, 168, 6, 24, 160, 6, 101, 168, 6, 24,
    ];
    ...
    common::test_load_old(func_name!(), bytes.as_slice(), 101, want())
}
