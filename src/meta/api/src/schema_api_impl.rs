...
use bigbytesdb_common_meta_app::app_error::CommitTableMetaError;
use bigbytesdb_common_meta_app::app_error::CreateAsDropTableWithoutDropTime;
use bigbytesdb_common_meta_app::app_error::CreateDatabaseWithDropTime;
use bigbytesdb_common_meta_app::app_error::CreateTableWithDropTime;
use bigbytesdb_common_meta_app::app_error::DatabaseAlreadyExists;
use bigbytesdb_common_meta_app::app_error::DropDbWithDropTime;
use bigbytesdb_common_meta_app::app_error::DropTableWithDropTime;
use bigbytesdb_common_meta_app::app_error::DuplicatedIndexColumnId;
use bigbytesdb_common_meta_app::app_error::IndexColumnIdNotFound;
use bigbytesdb_common_meta_app::app_error::MultiStmtTxnCommitFailed;
use bigbytesdb_common_meta_app::app_error::StreamAlreadyExists;
use bigbytesdb_common_meta_app::app_error::StreamVersionMismatched;
use bigbytesdb_common_meta_app::app_error::TableAlreadyExists;
use bigbytesdb_common_meta_app::app_error::TableLockExpired;
use bigbytesdb_common_meta_app::app_error::TableVersionMismatched;
use bigbytesdb_common_meta_app::app_error::UndropDbHasNoHistory;
use bigbytesdb_common_meta_app::app_error::UndropDbWithNoDropTime;
use bigbytesdb_common_meta_app::app_error::UndropTableAlreadyExists;
use bigbytesdb_common_meta_app::app_error::UndropTableHasNoHistory;
use bigbytesdb_common_meta_app::app_error::UndropTableWithNoDropTime;
use bigbytesdb_common_meta_app::app_error::UnknownDatabaseId;
use bigbytesdb_common_meta_app::app_error::UnknownStreamId;
use bigbytesdb_common_meta_app::app_error::UnknownTable;
use bigbytesdb_common_meta_app::app_error::UnknownTableId;
use bigbytesdb_common_meta_app::app_error::ViewAlreadyExists;
...
use bigbytesdb_common_meta_app::schema::catalog_id_ident::CatalogId;
use bigbytesdb_common_meta_app::schema::catalog_name_ident::CatalogNameIdentRaw;
use bigbytesdb_common_meta_app::schema::database_name_ident::DatabaseNameIdent;
use bigbytesdb_common_meta_app::schema::database_name_ident::DatabaseNameIdentRaw;
use bigbytesdb_common_meta_app::schema::dictionary_id_ident::DictionaryId;
use bigbytesdb_common_meta_app::schema::dictionary_name_ident::DictionaryNameIdent;
use bigbytesdb_common_meta_app::schema::dictionary_name_ident::DictionaryNameRsc;
use bigbytesdb_common_meta_app::schema::index_id_ident::IndexId;
use bigbytesdb_common_meta_app::schema::index_id_ident::IndexIdIdent;
use bigbytesdb_common_meta_app::schema::index_id_to_name_ident::IndexIdToNameIdent;
use bigbytesdb_common_meta_app::schema::index_name_ident::IndexName;
use bigbytesdb_common_meta_app::schema::least_visible_time_ident::LeastVisibleTimeIdent;
use bigbytesdb_common_meta_app::schema::marked_deleted_index_id::MarkedDeletedIndexId;
use bigbytesdb_common_meta_app::schema::marked_deleted_index_ident::MarkedDeletedIndexIdIdent;
use bigbytesdb_common_meta_app::schema::marked_deleted_table_index_id::MarkedDeletedTableIndexId;
use bigbytesdb_common_meta_app::schema::marked_deleted_table_index_ident::MarkedDeletedTableIndexIdIdent;
use bigbytesdb_common_meta_app::schema::table_niv::TableNIV;
use bigbytesdb_common_meta_app::schema::CatalogIdToNameIdent;
...
use bigbytesdb_common_meta_app::schema::DBIdTableName;
use bigbytesdb_common_meta_app::schema::DatabaseId;
use bigbytesdb_common_meta_app::schema::DatabaseIdHistoryIdent;
use bigbytesdb_common_meta_app::schema::DatabaseIdToName;
...
use bigbytesdb_common_meta_app::schema::DbIdList;
...
use bigbytesdb_common_meta_app::schema::GetDatabaseReq;
...
use bigbytesdb_common_meta_app::schema::IndexNameIdentRaw;
use bigbytesdb_common_meta_app::schema::LeastVisibleTime;
use bigbytesdb_common_meta_app::schema::ListCatalogReq;
use bigbytesdb_common_meta_app::schema::ListDatabaseReq;
use bigbytesdb_common_meta_app::schema::ListDictionaryReq;
use bigbytesdb_common_meta_app::schema::ListDroppedTableReq;
use bigbytesdb_common_meta_app::schema::ListDroppedTableResp;
...
use bigbytesdb_common_meta_app::schema::ListTableReq;
...
use bigbytesdb_common_meta_app::schema::MarkedDeletedIndexMeta;
use bigbytesdb_common_meta_app::schema::MarkedDeletedIndexType;
...
use bigbytesdb_common_meta_app::schema::SetTableColumnMaskPolicyAction;
...
use bigbytesdb_common_meta_app::schema::TableIdHistoryIdent;
use bigbytesdb_common_meta_app::schema::TableIdList;
use bigbytesdb_common_meta_app::schema::TableIdToName;
use bigbytesdb_common_meta_app::schema::TableIdent;
use bigbytesdb_common_meta_app::schema::TableIndex;
...
use bigbytesdb_common_meta_app::schema::UpdateTableMetaReply;
...
use bigbytesdb_common_meta_app::schema::VirtualColumnIdent;
...
use bigbytesdb_common_meta_types::TxnGetRequest;
...
impl<KV: kvapi::KVApi<Error = MetaError> + ?Sized> SchemaApi for KV {
    ...
    async fn update_multi_table_meta(
        ...
        // In issue: https://github.com/getbigbytes/bigbytesdb/issues/8897,
