...
use bigbytes_common_meta_app::app_error::CommitTableMetaError;
use bigbytes_common_meta_app::app_error::CreateAsDropTableWithoutDropTime;
use bigbytes_common_meta_app::app_error::CreateDatabaseWithDropTime;
use bigbytes_common_meta_app::app_error::CreateTableWithDropTime;
use bigbytes_common_meta_app::app_error::DatabaseAlreadyExists;
use bigbytes_common_meta_app::app_error::DropDbWithDropTime;
use bigbytes_common_meta_app::app_error::DropTableWithDropTime;
use bigbytes_common_meta_app::app_error::DuplicatedIndexColumnId;
use bigbytes_common_meta_app::app_error::IndexColumnIdNotFound;
use bigbytes_common_meta_app::app_error::MultiStmtTxnCommitFailed;
use bigbytes_common_meta_app::app_error::StreamAlreadyExists;
use bigbytes_common_meta_app::app_error::StreamVersionMismatched;
use bigbytes_common_meta_app::app_error::TableAlreadyExists;
use bigbytes_common_meta_app::app_error::TableLockExpired;
use bigbytes_common_meta_app::app_error::TableVersionMismatched;
use bigbytes_common_meta_app::app_error::UndropDbHasNoHistory;
use bigbytes_common_meta_app::app_error::UndropDbWithNoDropTime;
use bigbytes_common_meta_app::app_error::UndropTableAlreadyExists;
use bigbytes_common_meta_app::app_error::UndropTableHasNoHistory;
use bigbytes_common_meta_app::app_error::UndropTableWithNoDropTime;
use bigbytes_common_meta_app::app_error::UnknownDatabaseId;
use bigbytes_common_meta_app::app_error::UnknownStreamId;
use bigbytes_common_meta_app::app_error::UnknownTable;
use bigbytes_common_meta_app::app_error::UnknownTableId;
use bigbytes_common_meta_app::app_error::ViewAlreadyExists;
use bigbytes_common_meta_app::data_mask::MaskPolicyTableIdListIdent;
use bigbytes_common_meta_app::id_generator::IdGenerator;
use bigbytes_common_meta_app::schema::catalog_id_ident::CatalogId;
use bigbytes_common_meta_app::schema::catalog_name_ident::CatalogNameIdentRaw;
use bigbytes_common_meta_app::schema::database_name_ident::DatabaseNameIdent;
use bigbytes_common_meta_app::schema::database_name_ident::DatabaseNameIdentRaw;
use bigbytes_common_meta_app::schema::dictionary_id_ident::DictionaryId;
use bigbytes_common_meta_app::schema::dictionary_name_ident::DictionaryNameIdent;
use bigbytes_common_meta_app::schema::dictionary_name_ident::DictionaryNameRsc;
use bigbytes_common_meta_app::schema::index_id_ident::IndexId;
use bigbytes_common_meta_app::schema::index_id_ident::IndexIdIdent;
use bigbytes_common_meta_app::schema::index_id_to_name_ident::IndexIdToNameIdent;
use bigbytes_common_meta_app::schema::index_name_ident::IndexName;
use bigbytes_common_meta_app::schema::least_visible_time_ident::LeastVisibleTimeIdent;
use bigbytes_common_meta_app::schema::marked_deleted_index_id::MarkedDeletedIndexId;
use bigbytes_common_meta_app::schema::marked_deleted_index_ident::MarkedDeletedIndexIdIdent;
use bigbytes_common_meta_app::schema::marked_deleted_table_index_id::MarkedDeletedTableIndexId;
use bigbytes_common_meta_app::schema::marked_deleted_table_index_ident::MarkedDeletedTableIndexIdIdent;
use bigbytes_common_meta_app::schema::table_niv::TableNIV;
use bigbytes_common_meta_app::schema::CatalogIdToNameIdent;
...
use bigbytes_common_meta_app::schema::DBIdTableName;
use bigbytes_common_meta_app::schema::DatabaseId;
use bigbytes_common_meta_app::schema::DatabaseIdHistoryIdent;
use bigbytes_common_meta_app::schema::DatabaseIdToName;
...
use bigbytes_common_meta_app::schema::DbIdList;
...
use bigbytes_common_meta_app::schema::GetDatabaseReq;
...
use bigbytes_common_meta_app::schema::IndexNameIdentRaw;
use bigbytes_common_meta_app::schema::LeastVisibleTime;
use bigbytes_common_meta_app::schema::ListCatalogReq;
use bigbytes_common_meta_app::schema::ListDatabaseReq;
use bigbytes_common_meta_app::schema::ListDictionaryReq;
use bigbytes_common_meta_app::schema::ListDroppedTableReq;
use bigbytes_common_meta_app::schema::ListDroppedTableResp;
...
use bigbytes_common_meta_app::schema::ListTableReq;
...
use bigbytes_common_meta_app::schema::MarkedDeletedIndexMeta;
use bigbytes_common_meta_app::schema::MarkedDeletedIndexType;
...
use bigbytes_common_meta_app::schema::SetTableColumnMaskPolicyAction;
...
use bigbytes_common_meta_app::schema::TableIdHistoryIdent;
use bigbytes_common_meta_app::schema::TableIdList;
use bigbytes_common_meta_app::schema::TableIdToName;
use bigbytes_common_meta_app::schema::TableIdent;
use bigbytes_common_meta_app::schema::TableIndex;
...
use bigbytes_common_meta_app::schema::UpdateTableMetaReply;
...
use bigbytes_common_meta_app::schema::VirtualColumnIdent;
...
use bigbytes_common_meta_types::TxnGetRequest;
...
impl<KV: kvapi::KVApi<Error = MetaError> + ?Sized> SchemaApi for KV {
    ...
    async fn update_multi_table_meta(
        ...
        // In issue: https://github.com/getbigbytes/bigbytes/issues/8897,
