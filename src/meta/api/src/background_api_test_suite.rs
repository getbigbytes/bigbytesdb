...
use bigbytesdb_common_meta_app::background::BackgroundJobState::FAILED;
use bigbytesdb_common_meta_app::background::BackgroundJobStatus;
use bigbytesdb_common_meta_app::background::BackgroundJobType::INTERVAL;
use bigbytesdb_common_meta_app::background::BackgroundJobType::ONESHOT;
